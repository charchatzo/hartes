...
namespace Dive {
    public class Application : Gtk.Application {
        ...
        public override void activate () {
            ...
            dialog.artists = {"Charalabos Chatzoglou"};
            dialog.authors = {"Charalabos Chatzoglou"};
            dialog.documenters = null;
            dialog.translator_credits = null;

            dialog.program_name = "Deep Dive";
            dialog.comments = "A simple web browser";
            dialog.copyright = "Copyright © 2020 Charalabos Chatzoglou";
            dialog.version = "3.7";

            dialog.license = "GPLv3";
            dialog.wrap_license = true;

            dialog.website = "https://github.com/charchatzo/hartes";
            dialog.website_label = "Deep Dive repository";
            ...
            settings_section.attach_next_to (open_notes_from_file, set_duck_default_button, Gtk.PositionType.BOTTOM, 10, 10);
            settings_section.attach_next_to (about, open_notes_from_file, Gtk.PositionType.BOTTOM, 1, 1);
